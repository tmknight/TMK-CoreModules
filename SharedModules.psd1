...
@{
    ...
    Copyright         = '(c)2018 TMK World Headquarters'
    ...
    PrivateData       = @{
        PSData = @{
            Tags         = @(
                'DIOShared', 'DIO-Shared', 'DIO Shared', 'DIO'
            ...
            ReleaseNotes = '* 2017-03-15: tmknight: v1.0.0.0: Inception; Start-Multithreading function
