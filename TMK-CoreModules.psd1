...
@{
    ...
    FileList          = @(
        ...
        'Get-ADSite.ps1',
        'Get-NetworkInfo.ps1',
        'Invoke-Multithreading.ps1',
        'LICENSE',
        'README.md',
        'Test-FastPing.ps1',
        'Test-SubnetMember.ps1',
        'TMK-CoreModules.psd1',
    ...
    PrivateData       = @{
        PSData = @{
            ...
            * 2023-01-27: tmknight: v1.7.0: Rewrite module to more cleanly expose functions and eliminate dependency warnings'
        }
    }
}
